"""
Django settings for casa_verde project.
...
SECRET_KEY = 'django-insecure-wa==4dtwj974hhih@te#6so%qq+$8pjrn*9nw3ha!y_&v(z)_d'
...
WSGI_APPLICATION = 'casa_verde.wsgi.application'
...
#no estiendo ni la mitad de las cosas que modifique o toque pero funciona 
